...
class _ProfileScreenState extends State<ProfileScreen> {
  ...
  Map<int, String> articleStatuses = {}; // Cache for article statuses from tasks
  bool isLoading = true;
  Set<String> selectedStatusFilters = {}; // Filter by status: 'publicados', 'en_proceso', 'entregados'
    ...
    try {
      ...
      if (email != null) {
        ...
        if (currentUser?.id != null) {
          ...
          print('📦 Encontrados ${userArticles.length} artículos para usuario ${currentUser!.id}');
          ...
          // ✅ Load article statuses from tasks
    ...
    try {
      ...
      for (var article in userArticles) {
        ...
        if (taskStatusMap.containsKey(articleId)) {
          ...
          } else if (workflowStatus == 'en_proceso' || workflowStatus == 'sin_asignar') {
  ...
  void _calculateStats() {
    ...
    print('📊 Stats: $publicados publicados, $enProceso en proceso, $entregados entregados');
  }
          ...
          child: Column(
            ...
            children: [
              ...
              Wrap(
                ...
                runSpacing: 8,
                children: [
                  _buildFilterChip('Publicados', 'publicados', Colors.blue, setModalState),
                  _buildFilterChip('En Proceso', 'en_proceso', Colors.orange, setModalState),
                  _buildFilterChip('Entregados', 'entregados', Colors.green, setModalState),
                ],
              ),
              const SizedBox(height: 16),
              Row(
